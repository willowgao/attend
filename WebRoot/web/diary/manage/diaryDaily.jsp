...
<html>
	...
	<body>
		<form id="diaryDailyForm">
			...
			<!-- 历史弹出窗口 -->
			<div id="dlg" class="easyui-dialog" title="历史日志信息查询" style="width: 800px; height: 500px; padding: 10px;"
				data-options="
					iconCls: 'icon-search',
					toolbar: '#dlg-toolbar',
					resizable:true,
				...
				pageSize:5"
					...
					<thead>
						<tr>
							<th data-options="field:'diarydate',width:'20%',align:'center',formatter:formatterdate">
								填报日期
							</th>
