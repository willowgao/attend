			...
			<div class="easyui-panel" title="填报信息">
				...
				">
					<div style="margin: 10px;">
						...
						<input id="starttime" name="diaryDaily.starttime" class="easyui-datebox"
							value="<%=DateUtil.getFirstDateOfMonth(DateUtil.date2String(sysdate,DateUtil.FORMAT_MONTH))%>"
							data-options="formatter:fn_Dateformatter,parser:fn_DateParser"></input>
						</td>
						<label style="margin: 10px;">
							至：
						</label>
						<input id="endtime" name="diaryDaily.endtime" class="easyui-datebox"
							value="<%=DateUtil.getLastDateOfMonth(DateUtil.date2String(sysdate,DateUtil.FORMAT_MONTH))%>"
							data-options="formatter:fn_Dateformatter,parser:fn_DateParser"></input>
						</td>
						&nbsp;&nbsp;
