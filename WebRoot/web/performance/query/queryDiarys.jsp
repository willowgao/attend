...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=webapp%>/web/performance/query/js/queryDiary.js"></script>
			...
			<div class="easyui-panel" title="查询条件" style="width: 100%">
				<div style="margin-top: 10px; margin-bottom: 10px;">
					...
					<div style="margin: 10px; >
						...
						<label style="margin: 10px;margin-right: 13px;">
							部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门：
						</label>
						<input class="easyui-combobox" type="text" id="deptid" name="diaryDaily.deptid" />
						<label style="margin: 10px;">
							填 报 人：
						</label>
