...
<link id="ztree_style" rel="stylesheet" href="<%=request.getContextPath()%>/web/common/ztree/metroStyle/metroStyle.css" type="text/css">
<script type="text/javascript" src="<%=request.getContextPath()%>/web/common/jquery/jquery-migrate-1.2.1.js"></script>
