...
public class PerformanceIndex  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PerformanceIndex) ) return false;
		 PerformanceIndex castOther = ( PerformanceIndex ) other; 
         
		 return ( (this.getIndexid()==castOther.getIndexid()) || ( this.getIndexid()!=null && castOther.getIndexid()!=null && this.getIndexid().equals(castOther.getIndexid()) ) )
 && ( (this.getItem()==castOther.getItem()) || ( this.getItem()!=null && castOther.getItem()!=null && this.getItem().equals(castOther.getItem()) ) )
 && ( (this.getItemDetail()==castOther.getItemDetail()) || ( this.getItemDetail()!=null && castOther.getItemDetail()!=null && this.getItemDetail().equals(castOther.getItemDetail()) ) )
 && ( (this.getIndexContent()==castOther.getIndexContent()) || ( this.getIndexContent()!=null && castOther.getIndexContent()!=null && this.getIndexContent().equals(castOther.getIndexContent()) ) )
 && ( (this.getIndexScore()==castOther.getIndexScore()) || ( this.getIndexScore()!=null && castOther.getIndexScore()!=null && this.getIndexScore().equals(castOther.getIndexScore()) ) );
   }
